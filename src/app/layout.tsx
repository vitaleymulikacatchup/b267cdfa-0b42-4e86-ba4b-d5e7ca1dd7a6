...
export const metadata: Metadata = {
  title: "TrackField Pro - Elite Track & Field Training",
  description: "Professional track and field coaching with state-of-the-art facilities. Develop championship athletes through proven training methods and expert instruction.",
  keywords: "track and field, athletics training, coaching, sprints, distance running, field events, sports performance, athletic development",
  metadataBase: new URL("https://trackfieldpro.com"),
  alternates: {
    canonical: "https://trackfieldpro.com"
  },
  openGraph: {
    title: "TrackField Pro - Elite Track & Field Training",
    description: "Professional track and field coaching with state-of-the-art facilities. Develop championship athletes through proven training methods and expert instruction.",
    siteName: "TrackField Pro",
    images: [
      {
        url: "https://images.pexels.com/photos/163444/sport-treadmill-tor-route-163444.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Professional track and field stadium"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "TrackField Pro - Elite Track & Field Training",
    description: "Professional track and field coaching with state-of-the-art facilities. Develop championship athletes through proven training methods and expert instruction.",
    images: ["https://images.pexels.com/photos/163444/sport-treadmill-tor-route-163444.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
